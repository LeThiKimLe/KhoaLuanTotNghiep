...
test('renders footer component', () => {
    ...
    expect(getByText('Công ty cổ phần Xe khách Kim Nguyên - XEKIMNGUYEN')).toBeInTheDocument();
    expect(getByText('Địa chỉ:')).toBeInTheDocument();
    expect(getByText('Số 1 Võ Văn Ngân, Phường Linh Chiểu, Thành phố Thủ Đức')).toBeInTheDocument();
    ...
    expect(getByText('Copyright @ 2023 | Bản quyền thuộc về Công ty cổ phần Xe khách Kim Nguyên')).toBeInTheDocument();
});