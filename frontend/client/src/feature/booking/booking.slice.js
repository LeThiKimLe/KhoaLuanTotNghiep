...
export const selectBookingSessionTime = (state) =>
  state.booking.bookingSessionTime;
...
export const selectUserBookingHistory = (state) =>
  state.booking.userBookingHistory;
