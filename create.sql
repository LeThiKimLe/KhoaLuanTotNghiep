...
create table bus (id integer not null auto_increment, manufacture_year integer not null, state_id integer, type_id integer, availability varchar(255), color varchar(255), license_plate varchar(255) not null, primary key (id)) engine=InnoDB;
...
create table cancel_request (id integer not null auto_increment, policy_id integer, staff_id integer, request_time datetime(6), state varchar(255), primary key (id)) engine=InnoDB;
...
create table history (id integer not null auto_increment, policy_id integer, ticket_id integer, transaction_id integer, user_id integer, timestamp datetime(6) not null, action varchar(255) not null, primary key (id)) engine=InnoDB;
create table location (id integer not null auto_increment, is_active bit, name varchar(45) not null, primary key (id)) engine=InnoDB;
create table policy (for_special_day bit not null, id integer not null auto_increment, min_number_required integer not null, number_required integer not null, refund_rate float(23) not null, time_required float(23) not null, action varchar(255) not null, description varchar(255) not null, primary key (id)) engine=InnoDB;
create table review (id integer not null auto_increment, rate integer, reviewer_id integer, schedule_id integer, send_date datetime(6), comment varchar(255), state varchar(255) not null, primary key (id)) engine=InnoDB;
create table role (id integer not null auto_increment, role_name varchar(255) not null, primary key (id)) engine=InnoDB;
create table route (bus_type_id integer, departure integer, destination integer, distance integer not null, hours float(23), id integer not null auto_increment, is_active bit, parents integer, price integer not null, schedule varchar(250), primary key (id)) engine=InnoDB;
create table schedule (availability integer, bus_id integer, depart_date date not null, depart_time time(6) not null, driver_id integer, finish_time time(6) not null, id integer not null auto_increment, special_day_id integer, ticket_price integer not null, trip_id integer, note varchar(45), primary key (id)) engine=InnoDB;
...
create table staff (begin_work_date date, staff_id integer not null auto_increment, user_id integer, id_card varchar(15), address varchar(200), img varchar(255), nickname varchar(255), primary key (staff_id)) engine=InnoDB;
create table station (id integer not null auto_increment, is_active bit, latitude decimal(10,8), location_id integer, longitude decimal(11,8), name varchar(45) not null, address varchar(255) not null, primary key (id)) engine=InnoDB;
create table stop_station (arrival_time float(23), id integer not null auto_increment, is_active bit, station_id integer, trip_id integer, station_type varchar(255), primary key (id)) engine=InnoDB;
create table ticket (bill_id integer, cancel_request_id integer, checked_in bit not null, id integer not null auto_increment, schedule_id integer, ticket_price integer, booking_code varchar(7), seat varchar(45) not null, state varchar(255) not null, primary key (id)) engine=InnoDB;
create table transaction (amount float(53) not null, id integer not null auto_increment, payment_time datetime(6) not null, reference_id varchar(20) not null, payment_method varchar(255), transaction_type varchar(255) not null, primary key (id)) engine=InnoDB;
create table trip (end_station integer, id integer not null auto_increment, is_active bit, route_id integer, start_station integer, turn bit, primary key (id)) engine=InnoDB;
create table trip_bus (bus_id integer, trip_id integer, id bigint not null auto_increment, primary key (id)) engine=InnoDB;
create table trip_driver (driver_id integer, id integer not null auto_increment, trip_id integer, primary key (id)) engine=InnoDB;
...
alter table cancel_request add constraint UK_c95g646i6iivkl4hf2mavcyhj unique (policy_id);
...
alter table ticket add constraint UK_owwjifbr0upfpx1g0ge01iyl8 unique (bill_id);
...
alter table cancel_request add constraint FK2q4u3d7wikbqr27kbr2f1ie1s foreign key (policy_id) references policy (id);
alter table cancel_request add constraint FKbntrn526on297g5ejcc3o64f1 foreign key (staff_id) references staff (staff_id);
...
alter table schedule add constraint FKmjfuvpp6n6ce63ppi9j3xnntr foreign key (driver_id) references driver (driver_id);
...
alter table ticket add constraint FKi06dh6tk57bigrug81gw9n3c6 foreign key (cancel_request_id) references cancel_request (id);
...
alter table trip_bus add constraint FKbj5kxrme05jss89d7s8okqad8 foreign key (bus_id) references bus (id);
alter table trip_bus add constraint FKg3mlon21vkmden23hd8r7mcb9 foreign key (trip_id) references trip (id);
alter table trip_driver add constraint FKbawqpfphw4nj4btojknrmiajm foreign key (driver_id) references driver (driver_id);
alter table trip_driver add constraint FKb4aj0mnb3h4gqhst5077vjv02 foreign key (trip_id) references trip (id);
...
create table admin (admin_id integer not null auto_increment, staff_id integer, primary key (admin_id)) engine=InnoDB;
create table bill (id integer not null auto_increment, refer_code varchar(255), primary key (id)) engine=InnoDB;
create table booking (booking_user_id integer, conduct_staff_id integer, drop_station integer, is_ticketing bit not null, pick_station integer, ticket_number integer not null, transaction_id integer, trip_id integer, code varchar(7) not null, booking_date datetime(6) not null, email varchar(45) not null, order_id varchar(45), status varchar(45) not null, tel varchar(45) not null, name varchar(255), primary key (code)) engine=InnoDB;
create table bus (id integer not null auto_increment, manufacture_year integer not null, state_id integer, type_id integer, availability varchar(255), color varchar(255), license_plate varchar(255) not null, primary key (id)) engine=InnoDB;
create table bus_quality (id integer not null auto_increment, update_at date not null, air_condition varchar(255) not null, brake varchar(255) not null, electric varchar(255) not null, fuel varchar(255) not null, lighting varchar(255) not null, mirror varchar(255) not null, overall_state varchar(255) not null, steering varchar(255) not null, tire varchar(255) not null, primary key (id)) engine=InnoDB;
create table bus_type (capacity integer, fee integer, id integer not null auto_increment, seatmap_id integer, description varchar(255), name varchar(255), primary key (id)) engine=InnoDB;
create table cancel_request (id integer not null auto_increment, policy_id integer, staff_id integer, request_time datetime(6), state varchar(255), primary key (id)) engine=InnoDB;
...
create table stop_station (arrival_time float(23), id integer not null auto_increment, is_active bit, station_id integer, trip_id integer, station_type varchar(255), primary key (id)) engine=InnoDB;
create table ticket (bill_id integer, cancel_request_id integer, checked_in bit not null, id integer not null auto_increment, schedule_id integer, ticket_price integer, booking_code varchar(7), seat varchar(45) not null, state varchar(255) not null, primary key (id)) engine=InnoDB;
create table transaction (amount float(53) not null, id integer not null auto_increment, payment_time datetime(6) not null, payment_method varchar(255), transaction_no varchar(255), transaction_type varchar(255) not null, primary key (id)) engine=InnoDB;
create table trip (end_station integer, id integer not null auto_increment, is_active bit, route_id integer, start_station integer, turn bit, primary key (id)) engine=InnoDB;
create table trip_bus (bus_id integer, trip_id integer, id bigint not null auto_increment, primary key (id)) engine=InnoDB;
create table trip_driver (driver_id integer, id integer not null auto_increment, trip_id integer, primary key (id)) engine=InnoDB;
create table user (account_id integer, gender bit, id integer not null auto_increment, tel varchar(12) not null, email varchar(45), name varchar(45) not null, primary key (id)) engine=InnoDB;
